        ...
        <div className="w-[90%]">
          <div className=" flex flex-col items-center justify-between ">
            <h3 className="text-sm text-gray-500 ">
              <strong>A Plethora of Offers and Discounts at BookMyShow!</strong>
            </h3>
            <div className="text-xs text-gray-400 flex items-center justify-center py-6">
              <div className="text-start">
                ...
                Discover these special <strong>offers on movie tickets,</strong>
              ...
              <div className="flex w-[90%]  gap-4">
                <div className="flex flex-col text-start ">
                  ...
                  <div className="text-gray-400 text-xs text-justify">
                    ...
                    leading banks in India like ICICI, RBL, Citi Bank, SBI, Axis
                    Bank, HDFC, RBS, IndusInd, HDFC and many more. By availing
                    one of these Debit or <strong>credit card offers,</strong>{" "}
                    you can save massively on your movie tickets.
                  </div>
                </div>
                ...
                <div className="flex flex-col text-start ">
                  ...
                  <div className="text-gray-400 text-xs text-justify">
                    ...
                    <strong>movie ticket booking.</strong> Using providers like
                    Freecharge, MobiKwik, PayUMoney Payzapp, Ola Money, Pockets
                    by ICICI, and Airtel Money while booking movie tickets on
                    our platform, you can get instant cashback and discount.
                  </div>
                </div>
                ...
                <div className="flex flex-col text-start ">
                  ...
                  <div className="text-gray-400 text-xs text-justify">
                    We have some special offers for some selected* Vodafone and
                    Idea Users. If you are that lucky selected user, then you
                    can get up to 50% off on your movie tickets. It can't get
